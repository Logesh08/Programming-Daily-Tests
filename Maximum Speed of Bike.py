...
# An integer N and N integers are passed as input. A bike racing track is numbered with the given N integers in the order of their occurrence. Also two integers P and Q are passed as input. Whenever a racer crosses the number P, the speed of the bike is increased by P units per hour. Whenever a racer crosses the number Q, the speed of the bike is decreased by Q units per hour. Print the maximum speed achieved during the race. The initial speed of the bike is 40 units per hour.
